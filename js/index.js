 ...
 * para manter este elemento na sessão.
 * Daí poderemos usar ele durante as telas.
 */
function selectItem( itemName ){
	// ajax request para o servidor.
	// atualizar painel com os elementos.
	// atualizar painel principal.
	// alert('persistir... '+itemName);
}
